...
public class ModelParameterModifier extends org.jactr.tools.itr.ModelParameterModifier {
	...
	{
			ParametersBlock pb = getParametersBlock(fragment.getPackage());
			setParameter(pb, parameter, value);
	}
	
	protected ParametersBlock getParametersBlock(PackageDeclaration m)
	{
