...
class ModelToModelFragment {
	...
	@Inject 
	Provider<ResourceSet> _resourceSetProvider;
...
//    throw new RuntimeException("Incomplete implementation")
	...
	def createFakeFragment() {
		...
		val oldResource = _resourceSetProvider.get.getResource(uri, false)
		var resource = oldResource
		if (resource === null)
			resource = _resourceSetProvider.get.createResource(uri)
